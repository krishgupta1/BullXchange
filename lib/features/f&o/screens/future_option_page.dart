...
class _FutureOptionPageState extends State<FutureOptionPage>
  ...
  void _initializeStocks(InstrumentProvider provider) {
    ...
    // NOTE: This filter logic is copied from StockPage.
    // You may want to change this later to search F&O instruments.
  ...
  Widget _buildSearchBar() {
    return TextField(
      ...
      decoration: InputDecoration(
        hintText: "Search company, futures, options...", // Updated hint
    ...
    if (_searchController.text.isEmpty) {
      return const Center(
        child: Padding(
          ...
          child: Text("Start typing to search for F&O."),
        ),
      );
    }
